				...
				{#if contactsOpenDesktop}
					<div class="pt-2 pl-8">
						{#each contactItems as contact (contact.value)}
							<div class="flex items-center pt-1 text-xs">
	...
	<div class="flex flex-grow flex-col overflow-hidden lg:flex-row">
		...
		>
			<div class="hidden h-[42px] flex-shrink-0 border-b border-[#1E2D3D] lg:flex">
				<div class="flex items-center border-r border-[#1E2D3D] px-4 text-white">
					_contact-me
			...
			>
				{#if formSubmitted}
					<div class="text-center">
						<h2 class="mb-4 text-3xl text-white">Thank you! 👋</h2>
						<p class="mb-8 text-[#607B96]">
